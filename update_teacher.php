...
<div class="mb-3 d-block">
    ...
    <div class="row">
        <div class="col-md-6">
          <form action="code.php" method="POST">
            ...
            <input type="hidden" name="id" value="<?php echo $row['id']?>">
                ...
                <input type="text" name="name" placeholder="name" class="form-control" value="<?php echo $row['1']  ?>"style="text-transform: capitalize;" autofocus required>
            </div>
            
            <div class="form-group">
                <label><strong>Phone <span class="text-danger">*</span></strong></label>
                <input type="phone" name="phone" placeholder="phone" value="<?php echo $row['4']  ?>" class="form-control numbers" required maxlength="15">
            </div>
         </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="email" name="email" placeholder="email" value="<?php echo $row['2']  ?>" class="form-control" required>
            </div>
            <div class="form-group">
                <label><strong>Password <span class="text-danger">*</span></strong></label>
                <input type="password" name="password" placeholder="password" value="<?php echo $row['1']  ?>" class="form-control" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mt-4">
            <div class="form-group">
            <button class="btn btn-dark form-control" onClick="return confirm('Are you want to update teacher ?')">Submit</button>
        </div>  
        </div>
    </div>
