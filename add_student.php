        ...
        <div class="col-md-6">
         ...
         <div class="col-md-6">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="text" name="father" placeholder="Father name" class="form-control" required>
            </div>
        </div>
         ...
         <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="class" name="class" placeholder="class" class="form-control" required>
            </div>

             <div class="form-group">
                <label><strong>Mother name <span class="text-danger">*</span></strong></label>
                <input type="text" name="mother" placeholder="Mother name" class="form-control" required>
            </div>
        </div>
